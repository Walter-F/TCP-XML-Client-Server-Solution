...
namespace ClientTCP.Components
{
    public partial class RoundButton : Control
    {
        ...
        public new virtual System.Drawing.Image BackgroundImage { get; set; }

        public void SetBackgroundImage()
        {

            BackgroundImage = Properties.Resources.Rectangle;
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (var brush = new LinearGradientBrush(ClientRectangle, Color.FromArgb(255, 253, 251, 251), Color.FromArgb(255, 235, 237, 238), LinearGradientMode.Vertical))
